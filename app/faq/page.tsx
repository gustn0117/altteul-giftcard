...
const faqData: { category: string; items: FAQItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: '알뜰상품권는 에스크로(결제 대행) 서비스를 제공하나요?', a: '현재 알뜰상품권는 중개 서비스만을 제공하며, 결제 대행(에스크로) 서비스는 제공하지 않습니다. 거래 대금의 지급 및 상품권 전달은 회원 간 직접 이루어집니다.' },
...
export default function FAQPage() {
  return (
    <div className="max-w-[800px] mx-auto px-5 py-8">
      ...
      <p className="text-[13px] text-zinc-500 mb-8">알뜰상품권 이용 시 자주 묻는 질문들을 모았습니다.</p>
